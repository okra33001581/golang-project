...
func main() {
	...
	for rows.Next() {
		...
		tweet := Tweet{Id: id, Merchant_id: merchant_id, Merchant_name: merchant_name, User_id: user_id, Username: username, Group_tmp: group_tmp, In_total_amount: in_total_amount, Total_out_amount: total_out_amount, Valid_profit: valid_profit, Sum_turnover: sum_turnover, Prize_amount: prize_amount, Rebate_amount: rebate_amount, Game_profit_loss: game_profit_loss, Benefit_amount: benefit_amount, Day_salary: day_salary, System_subtraction: system_subtraction, Final_amount: final_amount, Date: date, Platform: platform, Model: model}
